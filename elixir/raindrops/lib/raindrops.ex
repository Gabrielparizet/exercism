defmodule Raindrops do
  ...
  def convert(number) when rem(number, 3) != 0, do: to_string(number)
  def convert(number) when rem(number, 5) != 0, do: to_string(number)
  def convert(number) when rem(number, 7) != 0, do: to_string(number)
end
